...
<template>
  <div id="how-does-it-work" class="mt-[4rem] md:mt-[7rem]">
    <div class="landing-container flex flex-col gap-4 md:gap-6">
      <div class="flex justify-center">
        <h3 class="flex">
          ...
          <div class="flex flex-col">
            ...
            <img src="@/assets/images/landing/how-does-it-work-vector-underline.svg" class="max-md:w-[87px]" />
          </div>
        </h3>
      </div>
      <div class="flex gap-[2.88rem] max-md:justify-center">
        <img src="@/assets/images/landing/how-does-it-work-1.png" loading="lazy"
          ...
          }" width="250" height="326" alt="Step 1 - Login with email or connect your wallet." />
        <img src="@/assets/images/landing/how-does-it-work-2.png" loading="lazy"
          class="max-md:transition-all max-md:duration-500 max-md:ease-in-out" :class="{
        ...
        <img src="@/assets/images/landing/how-does-it-work-3.png" loading="lazy" :class="{
            'max-md:hidden max-md:opacity-0': currentSlide !== 3,
            'max-md:opacity-100': currentSlide === 3,
          }" width="250" height="326" alt="Step 3 - Share the SendIt link on the recipient’s email address." />
        <img src="@/assets/images/landing/how-does-it-work-4.png" loading="lazy" :class="{
      ...
      <div class="md:hidden flex gap-4 justify-center items-center">
        <button v-for="i in 4" :key="`slide-${i}`" class="rounded-full" :class="{
